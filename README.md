...
`CONTENT_DIR` overrides the legacy monorepo-relative content path. Generated
...
- **Create new posts:** `pnpm new-post <slug> [title]` creates `../articles/posts/<slug>/<slug>.md`
- **Edit posts:** Modify files in `../articles/posts/`; `src/content/posts/` is generated by sync
...
| `pnpm new-post <slug> [title]` | Create a source post in `../articles/posts/` |
