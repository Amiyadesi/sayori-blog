...
- **創建新文章：** `pnpm new-post <slug> [標題]` 會創建 `../articles/posts/<slug>/<slug>.md`
- **編輯文章：** 修改 `../articles/posts/` 中的源檔案；`src/content/posts/` 是同步產物
...
- **published**: 發布日期（必要）
- **created**: 源檔案創建日期
- **updated** / **lastEdited**: 最後內容編輯日期，由發布流程更新
- **updateCount**: 發布時記錄的內容更新次數
...
| `pnpm new-post <slug> [標題]` | 在 `../articles/posts/` 創建源文章      |
