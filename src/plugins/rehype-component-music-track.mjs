...
const IS_ENGLISH_BUILD = String(process.env.SITE_LANG || "zh_CN")
	.toLowerCase()
	.startsWith("en");
	...
	return h(
		...
		[
			h("div", { class: "music-track-top" }, [
				h(
					"div",
					{ class: "music-track-cover-shell", "aria-hidden": "true" },
					[
						cover
							? h("img", {
							...
							: h(
									"div",
									{
										class: "music-track-cover music-track-cover--placeholder",
									},
									[
										h(
											"span",
											{ class: "music-track-cover-mark" },
											"♪",
										),
									],
								),
			...
			h("div", { class: "music-track-controls" }, [
				h(
					"button",
					{
						...
						"aria-label": `${IS_ENGLISH_BUILD ? "Play" : "播放"} ${title}`,
					},
					[
						h(
							"span",
							{
								class: "music-track-play-icon",
								"aria-hidden": "true",
							},
							"▶",
						),
						h(
							"span",
							{ class: "music-track-play-label" },
							IS_ENGLISH_BUILD ? "Play" : "播放",
						),
					],
				),
			]),
			h(
				"div",
				{ class: "music-track-status", "data-music-track-status": "" },
				IS_ENGLISH_BUILD ? "Ready" : "待播放",
			),
		],
	);
}
