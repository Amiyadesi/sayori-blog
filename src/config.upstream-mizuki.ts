...
export const siteConfig: SiteConfig = {
	...
	keywords: ["Amiya_desi", "个人博客", "Obsidian", "Cloudflare", "Vaultwarden"],
	...
	links: [
		...
		},
		{
			...
			children: [
				...
				{
					name: "资源索引",
					url: "/posts/resource-index/",
					icon: "material-symbols:bookmarks",
				},
				{
					name: "LDC 商店",
					url: "https://ldc.sayori.org/",
					external: true,
