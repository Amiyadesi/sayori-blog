...
<div class="paper-note paper-tape px-8 py-6" style="padding-top: 1.75rem;">
	{#each groups as group}
		<div>
			<div class="flex flex-row w-full items-center h-[3.75rem]">
				<div
					class="w-[15%] md:w-[10%] transition text-2xl font-bold text-right text-75 hand-font"
				>
					{group.year}
				</div>
			...
			{#each group.posts as post}
				...
				>
					...
					>
						<!-- date -->
						<div
							class="w-[15%] md:w-[10%] transition text-sm text-right text-50 hand-font"
						>
