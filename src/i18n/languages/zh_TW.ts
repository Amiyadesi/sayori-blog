...
export const zh_TW: Translation = {
	...
	[Key.friendsPaginationLabel]: "友鏈分頁",
	[Key.friendsPreviousPage]: "上一頁",
	[Key.friendsNextPage]: "下一頁",
	[Key.friendsPageLabel]: "第 {page} 頁",
	[Key.friendsTags]: "標籤",
	[Key.untitled]: "無標題",
	...
	//最後編輯時間卡片
	[Key.postHistory]: "歷史追蹤",
	[Key.postHistoryCreated]: "建立時間",
	[Key.postHistoryUpdateCount]: "修改次數",
	[Key.postHistoryLastEdited]: "最後修改",
	...
	[Key.postReward]: "打賞",
	[Key.postRewardAfdian]: "愛發電",
	[Key.postLike]: "點讚",
	[Key.postLiked]: "已點讚",
	[Key.postLikes]: "點讚",
	[Key.postLikesLoading]: "點讚載入中...",
	[Key.postShare]: "分享",
	[Key.postNativeShare]: "系統分享",
	[Key.postSharePlatform]: "分享到",
	[Key.postCommentsLoading]: "評論載入中...",
