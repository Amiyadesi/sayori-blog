...
export const ja: Translation = {
	...
	[Key.comments]: "コメント",
	[Key.friends]: "友達",
	[Key.friendsSubtitle]: "フレンドリンク、ブログ組織、サイトディレクトリ",
	...
	[Key.friendsPaginationLabel]: "友達リンクのページ切り替え",
	[Key.friendsPreviousPage]: "前へ",
	[Key.friendsNextPage]: "次へ",
	[Key.friendsPageLabel]: "{page} ページ",
	[Key.friendsTags]: "タグ",
	[Key.untitled]: "無題",
	...
	// 最終更新時間カード
	[Key.postHistory]: "履歴",
	[Key.postHistoryCreated]: "作成日",
	[Key.postHistoryUpdateCount]: "編集回数",
	[Key.postHistoryLastEdited]: "最終編集",
	[Key.postHistoryTimes]: "回",
	...
	[Key.postReward]: "支援",
	[Key.postRewardAfdian]: "愛発電",
	[Key.postLike]: "いいね",
	[Key.postLiked]: "いいね済み",
	[Key.postLikes]: "いいね",
	[Key.postLikesLoading]: "いいねを読み込み中...",
	[Key.postShare]: "共有",
	[Key.postNativeShare]: "システム共有",
	[Key.postSharePlatform]: "共有先",
	[Key.postCommentsLoading]: "コメントを読み込み中...",
