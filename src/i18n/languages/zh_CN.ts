...
export const zh_CN: Translation = {
	...
	[Key.comments]: "评论",
	[Key.friends]: "友链",
	[Key.friendsSubtitle]: "友情链接、博客组织与站点目录",
	...
	[Key.friendsPaginationLabel]: "友链分页",
	[Key.friendsPreviousPage]: "上一页",
	[Key.friendsNextPage]: "下一页",
	[Key.friendsPageLabel]: "第 {page} 页",
	[Key.friendsTags]: "标签",
	[Key.untitled]: "无标题",
	...
	// 番剧页面
	[Key.animeTitle]: "追番记录",
	[Key.animeSubtitle]: "先保留这个入口，之后慢慢整理真正想记录的内容",
	...
	// 短文页面
	[Key.diarySubtitle]: "短一点的记录，不适合写成长文章的东西",
	...
	// 相册页面
	[Key.albums]: "相册",
	[Key.albumsSubtitle]: "照片和截图以后会放在这里",
	[Key.albumsEmpty]: "暂无内容",
	[Key.albumsEmptyDesc]:
		"还没有创建相册。把相册文件夹放进 articles/albums/ 后会自动同步。",
	...
	//最后编辑时间卡片
	[Key.postHistory]: "历史追踪",
	[Key.postHistoryCreated]: "创建时间",
	[Key.postHistoryUpdateCount]: "修改次数",
	[Key.postHistoryLastEdited]: "最后修改",
	[Key.postHistoryTimes]: "次",
	...
	[Key.postReward]: "打赏",
	[Key.postRewardAfdian]: "爱发电",
	[Key.postLike]: "点赞",
	[Key.postLiked]: "已点赞",
	[Key.postLikes]: "点赞",
	[Key.postLikesLoading]: "点赞加载中...",
	[Key.postShare]: "分享",
	[Key.postNativeShare]: "系统分享",
	[Key.postSharePlatform]: "分享到",
	[Key.postCommentsLoading]: "评论加载中...",
